...
function AdminHome() {
  ...
  async function downloadHisobot() {
    setLoading(true);
    try {
      const response = await fetch(`${baseUrl}/api/v1/books/hisobot`, {
        method: "GET",
        headers: {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <main className="lg:ml-72 p-4 md:p-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <StatCard
            title="Jami Kitoblar"
            value={stats.booksCount + stats.badiiyCount + stats.audioCount}
            icon={<FiBookmark />}
            color="bg-blue-500"
            trend={stats.last7DaysBooks+ stats.audioCount+stats.badiiyCount}
            delay={0}
          />
          <StatCard
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {edu.faculties.map((fac) => (
                        <div
                          ...
                          onClick={() =>
                            navigate(
                              `/admin/faculty-statistic/${fac.facultyId}`,
                            )
                          }
        ...
        >
          ...
          <div>
            <button
              onClick={() => downloadHisobot()}
              className={"p-4 bg-blue-700 rounded-2xl text-white"}
            >
            ...
            {[
              {
                icon: <FiBook />,
                label: "Yangi Kitob",
                desc: "Elektron kitob qo'shish",
                color: "blue",
                link: "/admin/books",
              },
              {
                icon: <FiUsers />,
                label: "Yangi Fakultet",
                desc: "Fakultet yaratish",
                color: "green",
                link: "/admin/faculty",
              },
              {
              ...
              {
                icon: <FiLink />,
                label: "Fan Biriktirish",
                desc: "Fakultetga fan biriktirish",
                color: "orange",
                link: "/admin/faculty-subjects",
              },
            ].map((action, index) => (
              <a
                key={index}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-xl p-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {stats.facultiesCount > 0
                    ? (stats.booksCount / stats.facultiesCount).toFixed(1)
                    : 0}
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {stats.facultiesCount > 0
                    ? (
                        stats.facultySubjectsCount / stats.subjectsCount
                      ).toFixed(1)
                    : 0}
                  %
